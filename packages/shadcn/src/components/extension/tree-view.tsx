...
type TreeViewProps = {
  ...
  | { initialExpendedItems?: string[]; expandAll?: false }
  | { initialExpendedItems?: undefined; expandAll: true }
)
...
export const TreeView = ({
  ...
  const { height = getTotalSize(), width } = useResizeObserver({ ref: containerRef });
  return (
    <div
      ref={containerRef}
...
export const TreeItem = forwardRef<
  HTMLUListElement,
  { elements?: TreeViewElement[]; indicator?: boolean } & React.HTMLAttributes<HTMLUListElement>
