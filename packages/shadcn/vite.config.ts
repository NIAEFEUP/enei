  ...
  build: {
    ...
    lib: {
      ...
      entry: {
        ...
        "lib/components/phone-input/phone-input": resolve(__dirname, 'lib/components/phone-input/phone-input'),
        "lib/components/form/location-input": resolve(__dirname, 'lib/components/form/location-input'),
        "lib/components/extension/datetime-picker": resolve(__dirname, 'lib/components/extension/datetime-picker'),
        "lib/components/extension/file-upload": resolve(__dirname, 'lib/components/extension/file-upload'),
        "lib/components/extension/multi-select": resolve(__dirname, 'lib/components/extension/multi-select'),
        "lib/components/extension/otp-input": resolve(__dirname, 'lib/components/extension/otp-input'),
        "lib/components/extension/smart-datetime-input": resolve(__dirname, 'lib/components/extension/smart-datetime-input'),
        "lib/components/extension/tags-input": resolve(__dirname, 'lib/components/extension/tags-input'),
        "lib/components/extension/tree-view": resolve(__dirname, 'lib/components/extension/tree-view'),
      },
    },
  },
  resolve: {
