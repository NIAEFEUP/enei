    ...
    return (
        <Tabs defaultValue="events">
            <TabsList className="w-full">
                <TabsTrigger value="events" className="w-full">Eventos</TabsTrigger>
                <TabsTrigger value="store" className="w-full">Loja</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="store" className="mt-4">
                <Container className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 justify-center">
                    <StoreReservedProducts
                        products={activityInformation?.store}
                    />
                </Container>
            </TabsContent>
        </Tabs>
