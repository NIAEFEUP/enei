...
import { ChevronDown, X } from "@enei/shadcn/icons";
  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "border-input ring-offset-background focus-within:ring-ring min-h-10 rounded-md border bg-white text-base focus-within:ring-2 focus-within:ring-offset-2 md:text-sm",
            {
        ...
        >
          <div className="relative flex flex-wrap items-center gap-1 pr-3">
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
