...
import { CheckIcon, Loader2, LucideIcon, X } from "@enei/shadcn/icons";
...
const StepperProvider = ({ value, children }: StepperContextProviderProps) => {
  ...
  return (
    <StepperContext.Provider
      value={{ ...value, isError, isLoading, activeStep, nextStep, prevStep, resetSteps, setStep }}
    >
      {children}
    </StepperContext.Provider>
  );
...
interface StepOptions {
  ...
  variables?: { "--step-icon-size"?: string; "--step-gap"?: string };
  ...
  return (
    <>
      {React.Children.map(children, (child, i) => {
        ...
        const stepProps = { index: i, isCompletedStep, isCurrentStep, isLastStep };
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "max-w-full",
        verticalStepVariants({ variant: variant?.includes("circle") ? "circle" : "line" }),
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "[&:not(:last-child)]:after:transition-all [&:not(:last-child)]:after:duration-200",
        "[&:not(:last-child)]:after:bg-enei-beige [&:not(:last-child)]:after:h-[2px] [&:not(:last-child)]:after:content-['']",
        "data-[completed=true]:[&:not(:last-child)]:after:bg-primary",
        "data-[invalid=true]:[&:not(:last-child)]:after:bg-destructive",
        variant === "circle-alt"
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "border-enei-beige flex items-center justify-center rounded-full border-2",
...
const iconVariants = cva("", {
  variants: { size: { sm: "size-4", md: "size-4", lg: "size-5" } },
