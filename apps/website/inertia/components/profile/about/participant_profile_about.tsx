...
import { ExternalLink, GraduationCap, Landmark, LucideProps, Maximize2, Minimize2 } from "lucide-react";
...
export default function ParticipantProfileAbout({
    profile
}: ParticipantProfileAboutProps) {
