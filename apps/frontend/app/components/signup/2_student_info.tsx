...
import CurricularYearSelector, { type CurricularYearSelectorType } from "./input/curricular_year_input";
...
import { type EducationInfo, educationInfoSchema } from "#pages/signup/schema";
