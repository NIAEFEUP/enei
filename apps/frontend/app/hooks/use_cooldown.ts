...
type UseCooldownProps = { seconds: number; onThrottledActivation?: () => MaybePromise<void> };
...
type UseCooldownResult = { throttle: Throttler } & (
  | { active: true; secondsLeft: number }
  | { active: false; secondsLeft?: undefined }
);
